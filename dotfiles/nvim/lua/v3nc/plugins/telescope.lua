...
{ -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
        ...
        vim.keymap.set('n', '<leader>tg', '<CMD>Telescope git_worktree git_worktree<CR>',        { desc = 'Worktrees: switch' })
        vim.keymap.set('n', '<leader>tG', '<CMD>Telescope git_worktree create_git_worktree<CR>', { desc = 'Worktrees: create' })
